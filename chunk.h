...
typedef enum {
    ...
    OP_RETURN, OP_POP_TOP, OP_CONST_JMP, OP_COND_JMP, OP_LOAD, OP_STORE, OP_PUTS,
    OP_CALL, OP_BIND, OP_LT, OP_LTE, OP_GT, OP_GTE, OP_EQU, OP_IS, OP_AND, OP_OR,
    OP_NEW, OP_LOADATTR, OP_STOREATTR, OP_BIND_NEW
} OpCode;
